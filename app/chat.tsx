...
const ConversationScreen = () => {  
  ...
  useEffect(() => {  
    const fetchMessages = async () => {  
      try {  
        const data = await getMessages(conversationId);  // Use conversationId here
        setMessages(data);  
      } catch (error) {  
  ...
  const handleSendMessage = async () => {  
    ...
    try {  
      await sendMessage(conversationId, newMessage);  // Use conversationId here
      const newEntry = {  
        id: Date.now(),  
        text: newMessage,  
        sender: 'me',  
  ...
  const handleTyping = async (text: string) => {  
    setNewMessage(text);  
    try {  
      await sendTypingStatus(conversationId);  // Use conversationId here
    } catch (error) {  
